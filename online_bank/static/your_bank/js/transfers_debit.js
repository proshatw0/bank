document.querySelector('.data-debit').addEventListener('submit', function(event) {
    ...
    formData.append('number_card', form.querySelector('#number_card').value);
    ...
    document.getElementById('number_card').style.boxShadow = '0 0 10px rgba(0, 0, 0, 0.25)';
    ...
    const requestOptions = {
        ...
        body: JSON.stringify({
            number_card: form.querySelector('#number_card').value,
